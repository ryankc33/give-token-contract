...
/// @title Give token contract.
contract GiveToken is Ownable, BasicToken, TokenHolder {
    using SafeMath for uint256;

    string public constant name = "Give";
    ...
    /// @dev Mint GIV tokens.
    /// @param _to address Address to send minted GIV to.
    /// @param _amount uint256 Amount of GIV tokens to mint.
